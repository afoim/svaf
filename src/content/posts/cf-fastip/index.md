...
![QmZoinxZgAzu7Skh7BqsxmDQGU1sXtLLskJcyQuRAQNKww.webp](/public/assets/images/098f9ee71ae62603022e542878673e19bdcaf196.webp)

#### 已优选

![](img/cf-fastip-11.webp)
...
![](img/838f685e-3913-4b21-995e-5ee149f4bffa.webp)
...
![](img/56752d54-26a5-46f1-a7d9-a782ad9874cb.webp)

类似这样填写：

![](img/d025398c-39e3-4bd7-8d8f-2ce06a45007d.webp)
...
1. 首先新建一个DNS解析，指向你的**源站**，**开启cf代理**
   ![QmfBKgDe77SpkUpjGdmsxqwU2UabvrDAw4c3bgFiWkZCna.webp](img/c94c34ee262fb51fb5697226ae0df2d804bf76fe.webp)
...
3. 点击添加自定义主机名。设置一个自定义主机名，比如 `onani.cn`，然后选择**自定义源服务器**，填写第一步的域名，即 `xlog.acofork.cn`。
   ...
   ![QmRYrwjeDMDQCj8G9RYkpjC3X4vpwE77wpNpbqKURwBber.webp](img/f6170f009c43f7c6bee4c2d29e2db7498fa1d0dc.webp)

4. 继续在你的辅助域名添加一条解析。CNAME到优选节点：如cloudflare.182682.xyz，**不开启cf代理**
   ![QmNwkMqDEkCGMu5jsgE6fj6qpupiqMrqqQtWeAmAJNJbC4.webp](img/4f9f727b0490e0b33d360a2363c1026003060b29.webp)

5. 最后在你的主力域名添加解析。域名为之前在辅助域名的自定义主机名（onani.cn），目标为刚才的cdn.acofork.cn，**不开启cf代理**
   ![QmeK3AZghae4J4LcJdbPMxBcmoNEeF3hXNBmtJaDki8HYt.webp](img/6f51cb2a42140a9bf364f88a5715291be616a254.webp)

6. 优选完毕，确保优选有效后尝试访问
   ![](img/cf-fastip-10.webp)
