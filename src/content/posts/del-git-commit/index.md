...
![](img/del-git-commit-4.webp)

可以看到，效果非常拔群， **微信密码.txt** 已经不翼而飞了

![](img/del-git-commit-3.webp)
...
![](img/del-git-commit-10.webp)

新工单

![](img/del-git-commit-11.webp)

从我拥有或控制的存储库中删除数据

![](img/del-git-commit-12.webp)

删除其他数据

![](img/del-git-commit-13.webp)
