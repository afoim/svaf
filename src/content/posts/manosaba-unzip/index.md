...
![](img/manosaba-unzip.webp)

![](img/manosaba-unzip-5.webp)
接下来会进入漫长的等待时间。网页会卡在加载，我们可以查看一并打开的命令窗口确认资源载入进度
当你发现 **查看已导入文件** 可被点击后，方可继续
![](img/manosaba-unzip-6.webp)
选择右上角的 `导出 - 导出所有文件`
![](img/manosaba-unzip-7.webp)
点击选择文件夹，随便选个位置放解包后的文件
![](img/manosaba-unzip-8.webp)
然后点击 **导出主要内容**
![](img/manosaba-unzip-9.webp)
最终，寻找类似 `Assets` 文件夹，就有所有的资源文件了（如CG图，MV，角色语音等）
![](img/manosaba-unzip-10.webp)
