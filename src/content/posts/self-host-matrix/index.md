...
![](img/2025-08-02-17-27-10-image.webp)

相关信息可以在连接信息看到

![](img/2025-08-02-17-27-53-image.webp)

**删除**刚刚创建的 `synapse` 这个数据库

![](img/2025-08-02-17-28-49-image.webp)

重新创建同名数据库

设置所有者（即用户名）为 `synapse` 

![](img/2025-08-02-17-29-36-image.webp)

将 `排序规则` 和 `字符类型` 都改为 `C`

![](img/2025-08-02-17-30-34-image.webp)

# 部署Synapse

首先参照1Panel官方的教程去创建一个存储卷，否则安装 `synapse` 会失败

![](img/2025-08-02-17-32-00-image.webp)
...
![](img/2025-08-02-17-33-50-image.webp)
