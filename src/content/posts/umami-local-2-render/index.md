...
![](img/2025-08-28-10-03-58-image.webp)

填写 **文件名** 创建备份。备份的文件将会保留在 **pgAdmin4** 上

![](img/2025-08-28-10-04-44-image.webp)

# 还原备份到云端数据库

> 免费计划有 500MB 免费的数据库空间，完全够用了
> 
> ![](img/2025-08-28-10-06-39-2dfd6b861774ca0b05d460fc19bfccb1.webp)
...
![](img/2025-08-28-10-07-41-image.webp)

在 **pgAdmin4** 中，连接到Supabase数据库

![](img/2025-08-28-10-10-00-image.webp)
...
![](img/2025-08-28-10-12-10-image.webp)

选择刚才备份的数据库文件

![](img/2025-08-28-10-12-29-image.webp)

进行还原，必会 **失败**，但是不用管

*这些报错大概就是，找不到之前数据库的用户之类的，实际上表结构已经被还原了*

![](img/2025-08-28-10-16-25-image.webp)
...
![](img/2025-08-28-10-25-05-image.webp)

而 **DATABASE_URL** 可以在 Supabase 中看到

![](img/2025-08-28-10-25-44-image.webp)
...
![](img/2025-08-28-10-29-02-image.webp)

尝试访问，应该已经迁移成功

![](img/2025-08-28-10-29-46-image.webp)
...
![](img/2025-08-28-10-32-09-image.webp)

CORS配置详情

![](img/2025-08-28-10-32-32-image.webp)
