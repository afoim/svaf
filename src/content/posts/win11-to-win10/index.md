...
![](img/win11-to-win10-1.webp)

点击F12，打开Devtools，切换为设备仿真
![](img/win11-to-win10-2.webp)

按F5，刷新页面，此时网页就会认为你是手机，就会让你下载ISO了
![](img/win11-to-win10-3.webp)

选择版本 **Windows 10 （多版本ISO）**
![](img/win11-to-win10-5.webp)

选择 **简体中文**
![](img/win11-to-win10-6.webp)

下载 **64位版本的ISO**
![](img/win11-to-win10-7.webp)

得到ISO文件
![](img/win11-to-win10-8.webp)

确保你安装了 **支持解压缩ISO** 的软件，如 [Bandizip 官方网站 - 免费压缩软件下载 (Windows)](https://www.bandisoft.com/bandizip/) ，**解压ISO文件**
![](img/explorer_xY0rowaOaU.gif)

打开 **已解压的ISO** 文件夹，重命名 `setup.exe` 为 `setup1.exe`
![](img/win11-to-win10-11.webp)

更改文件属性 - 兼容性为 **Windows 8** 
![](img/explorer_6TrQ3aXWcR.gif)
...
![](img/win11-to-win10-13.webp)

![](img/explorer_9vcYIunVJH.gif)

打开 `setup1.exe` ，**更改 Windows 安装程序下载更新的方式**，选择 **不是现在**，然后一路下一步
![](img/SetupHost_dtT7QeMuhO.gif)

等待变为 **准备就绪，可以安装** ，并确保 **保留个人文件和应用** ，选择 **安装** 
![](img/win11-to-win10.webp)

等待设备开机时从 **白条转圈** 变为 **白点转圈** ，即Windows10已被安装
![](img/win11-to-win10-15.webp)
